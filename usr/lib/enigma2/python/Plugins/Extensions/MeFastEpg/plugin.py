...
from MediaSat.MeEpgPanel import MediaSatDownEpgNow, MediaSatEpgChannels, nab_Get_EpgProvider
...
class Bh_Fastepg_main(Screen):
    ...
    def __init__(self, session):
        ...
        self['list'] = List(['Download ita OpenEpg',
         'Update ita epg channel list',
         'Download uk OpenEpg',
         'Update uk epg channel list'])
    ...
    def downEpg(self, provider):
        self.session.open(MediaSatDownEpgNow, provider)

    def updateChans(self, provider):
        self.session.open(MediaSatEpgChannels, provider)
